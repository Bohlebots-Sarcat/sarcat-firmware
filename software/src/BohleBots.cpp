...
int BohleBots::ballFahre(int type, bool debugModeOn) {
    ...
    switch (type) {
        case 3:
            richtung = ballFahre_3();
            ERROR = false;
            break;
        case 4:
            richtung = ballFahre_4();
            ERROR = false;
            break;
        default:
            richtung = 0;
    ...
    if (debugModeOn) Serial.println("Bohlebots::ballfahre returned: " + String("type = ") + String(type) + String("richtung = ") + String(richtung) + String("Error = ") + String(ERROR));

}

int BohleBots::ballFahre_3() {
    int richtung = 0;
    switch (ballRichtung()) {
        case -7:
        case -6:
